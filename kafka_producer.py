...
class UserSession:
    ...
    def __init__(self, user_id: int, brand: str):
        ...
        self.referrer = random.choice([
            'direct', 'google', 'facebook', 'twitter', 'newsletter', 
            'internal', 'reddit', 'linkedin', 'bing'
        ])
    ...
    def _get_city_for_country(self, country: str) -> str:
        cities = {
            ...
            'US': ['New York', 'Washington DC', 'Los Angeles', 'Chicago', 'San Francisco'],
    ...
    def _get_timezone(self, country: str) -> str:
        timezones = {
            ...
            'US': 'America/New_York', 'UK': 'Europe/London', 'FR': 'Europe/Paris',
            'AU': 'Australia/Sydney', 'EU': 'Europe/Brussels'
        }
    ...
    def _generate_engagement_metrics(self, event_type: str) -> Dict[str, Any]:
        ...
        if event_type == 'article_view':
            ...
            metrics['search_query'] = random.choice([
                'politics', 'sports news', 'business update', 'tech review',
                'weather', 'stock market', 'election results'
            ])
