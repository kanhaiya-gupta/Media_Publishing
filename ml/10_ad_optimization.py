...
def load_ad_data(client, limit=100000):
    ...
    columns = [
        ...
        'subscription_tier', 'user_segment', 'ad_clicks',
        'article_views', 'session_duration_sec', 'total_events',
        'session_start', 'clicked_ad', 'revenue'
    ]
...
def create_ad_features(df):
    ...
    article_stats.columns = ['article_id', 'article_avg_ad_clicks', 'article_avg_revenue', 'article_avg_views']
...
def main():
    ...
    try:
        ...
        feature_columns = [
            ...
            'article_views', 'session_duration_sec', 'total_events',
            'user_ad_clicks_mean', 'user_revenue_mean',
            'article_avg_revenue', 'brand_avg_revenue'
        ]
        
        available_features = [f for f in feature_columns if f in df.columns]
        
        # One-hot encode categorical
        categorical_features = ['brand', 'category', 'device_type', 'country', 'subscription_tier']
        ...
        all_features = [f for f in all_features if f not in ['user_id', 'session_id', 'article_id', 'session_start', 'revenue', 'clicked_ad', 'ad_clicks']]
