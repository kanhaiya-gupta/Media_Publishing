...
def get_user_level_features(client, sample_size=10000):
    ...
    columns = [
        'user_id', 'total_sessions', 'avg_session_duration', 'avg_events_per_session',
        'avg_article_views', 'avg_article_clicks', 'avg_video_plays',
        'avg_newsletter_signups', 'avg_pages_per_session', 'avg_categories_diversity',
        'has_newsletter', 'current_subscription_tier', 'primary_country',
        'primary_device', 'preferred_brand', 'first_session', 'last_session', 'days_active'
    ]
