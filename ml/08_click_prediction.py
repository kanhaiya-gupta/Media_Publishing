...
def load_click_data(client, limit=100000):
    ...
    columns = [
        'user_id', 'article_id', 'article_title', 'category', 'brand',
        'device_type', 'device_os', 'browser', 'country', 'city',
        'subscription_tier', 'user_segment', 'referrer', 'timezone',
        'article_views', 'article_clicks', 'clicked', 'session_duration_sec',
        'total_events', 'pages_visited_count', 'session_start'
    ]
...
def create_click_features(df):
    ...
    user_stats.columns = ['user_id', 'user_avg_clicks', 'user_total_clicks', 'user_interactions',
                          'user_avg_views', 'user_total_views', 'user_avg_duration', 'user_avg_events']
    ...
    article_stats.columns = ['article_id', 'article_avg_clicks', 'article_total_clicks', 'article_interactions',
                             'article_avg_views', 'article_total_views']
...
def prepare_click_features(df):
    ...
    # Select features
    numerical_features = [
        'article_views', 'session_duration_sec', 'total_events', 'pages_visited_count',
        'hour', 'day_of_week', 'is_weekend',
        'user_avg_clicks', 'user_total_clicks', 'user_interactions',
        'user_avg_views', 'user_total_views', 'user_avg_duration', 'user_avg_events',
        'article_avg_clicks', 'article_total_clicks', 'article_interactions',
        'article_avg_views', 'article_total_views',
        'user_ctr', 'article_ctr'
    ]
    
    categorical_features = [
        'category', 'brand', 'device_type', 'device_os', 'browser',
        'country', 'subscription_tier', 'user_segment'
    ]
    ...
    exclude_cols = ['user_id', 'article_id', 'article_title', 'city', 'referrer', 'timezone', 'session_start', 'clicked', 'article_clicks']
