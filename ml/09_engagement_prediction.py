...
def load_engagement_data(client, limit=100000):
    ...
    columns = [
        'user_id', 'session_id', 'brand', 'category', 'article_id',
        'device_type', 'device_os', 'browser', 'country',
        'subscription_tier', 'user_segment', 'session_start',
        'session_duration_sec', 'total_events', 'article_views',
        'article_clicks', 'video_plays', 'searches',
        'pages_visited_count', 'unique_categories_count', 'engagement_score'
    ]
...
def prepare_engagement_features(df):
    ...
    # Select features
    numerical_features = [
        'session_duration_sec', 'total_events', 'article_views', 'article_clicks',
        'video_plays', 'searches', 'pages_visited_count', 'unique_categories_count',
        'hour', 'day_of_week', 'is_weekend', 'month',
        'user_engagement_score_mean', 'user_engagement_score_std',
        'user_session_duration_sec_mean', 'user_total_events_mean',
        'article_engagement_score_mean', 'article_article_views_mean',
        'brand_avg_engagement', 'category_avg_engagement'
    ]
    
    categorical_features = [
        'brand', 'category', 'device_type', 'device_os', 'browser',
    ...
    exclude_cols = ['user_id', 'session_id', 'article_id', 'session_start', 'engagement_score']
